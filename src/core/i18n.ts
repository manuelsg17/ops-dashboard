...
export const I18N: Record<string, Record<string, string>> = {
  ...
  "metas.cobertura.hint":   { es: "Conductores Activos no se ve afectado (es un nivel, no se acumula). Ampliá el rango a todo el mes para leer el cumplimiento real.",
  ...
  "metas.cobertura.sinPeriodos": { es: "El rango de fechas del sidebar no incluye ningún período de <strong>{mes}</strong>, que es el mes de la meta seleccionada.<br>Ampliá el rango (o cambiá el mes de la meta) para ver el avance.",
