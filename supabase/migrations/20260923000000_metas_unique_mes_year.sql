-- COPIA PARA EL ENTORNO LOCAL (`supabase db reset`). Fuente de verdad:
-- migrations/2026-09-23_metas_unique_mes_year.sql. Sin BEGIN/COMMIT porque el
-- CLI ya aplica cada archivo de forma atómica. NO se usa para producción.
--
