...
Pendiente: aplicar `2026-07-28_access_log.sql` y verificación con datos y sesión reales (lo de arriba se validó con build real + datos sintéticos en `npm run preview`; no hay login por la regla de contraseñas).
