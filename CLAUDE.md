...
- **La copia del parser no puede divergir**: `npm run sync:ingest` la regenera y el CI corre `--check`. Ver `supabase/functions/ingest-taxiparks/README.md` para el contrato completo.
