...
- Decisión abierta: en la Calculadora real, una celda fijada a mano NO redistribuye el resto (el prototipo sí lo hacía); el cuadre avisa "No cuadra". Cambiarlo toca la matemática del reparto.
